 ...
 */
package com.blt.talk.message.server.utils.pinyin;
...
public class HanziToPinyin3 {
    ...
    private static Logger logger = LoggerFactory.getLogger(HanziToPinyin3.class);
...
//    private static final Collator COLLATOR = Collator.getInstance(Locale.CHINA);
        ...
        synchronized (HanziToPinyin3.class) {
            ...
            for (int i = 0; i < locale.length; i++) {
                if (locale[i].equals(Locale.CHINESE)) {
                    ...
                    logger.debug("Self validation. Result: " + doSelfValidation());
    ...
    private static boolean doSelfValidation() {
        ...
        for (char c : UNIHANS) {
            ...
            if (cmp >= 0) {
                logger.error("Internal error in Unihan table. " + "The last string \"" + lastString
