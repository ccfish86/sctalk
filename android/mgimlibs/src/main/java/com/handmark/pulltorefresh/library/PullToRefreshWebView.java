...
import com.polites.android.FloatMathX;
...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullEnd() {
		...
		float exactContentHeight = FloatMathX.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale());
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return (int) Math.max(0, FloatMathX.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale())
