...
public class GroupManagerAdapter extends BaseAdapter {
    ...
    private void setGroupData(GroupEntity entity){
        ...
        long ownerId = entity.getCreatorId();
        IMContactManager manager = imService.getContactManager();
        for(Long memId:entity.getlistGroupMemberIds()){
	...
	public void removeById(long contactId) {
			...
			if (contactEntity != null) {
				...
				holder.deleteImg.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
                        ...
                        long userId = holder.contactEntity.getPeerId();
                        removeById(userId);
                        Set<Long> removeMemberlist = new HashSet<>(1);
