...
public class MessageEntity implements java.io.Serializable {
    ...
    public MessageEntity(Long id, long msgId, long fromId, long toId, String sessionKey, String content, int msgType, int displayType, int status, int created, int updated) {
        this.id = id;
        this.msgId = msgId;
        this.fromId = fromId;
        this.toId = toId;
    ...
    public int hashCode() {
        ...
        result = 31 * result + Long.valueOf(msgId).hashCode();
        result = 31 * result + Long.valueOf(fromId).hashCode();
        result = 31 * result + Long.valueOf(toId).hashCode();
