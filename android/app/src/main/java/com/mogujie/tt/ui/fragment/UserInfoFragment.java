...
public class UserInfoFragment extends MainFragment {
    ...
    private IMServiceConnector imServiceConnector = new IMServiceConnector(){
        ...
        public void onIMServiceConnected() {
            ...
            currentUserId = getActivity().getIntent().getLongExtra(IntentConstant.KEY_PEERID,0);
            if(currentUserId == 0){
	...
	private void initDetailProfile() {
		...
		setTextViewContent(R.id.department,deptEntity == null? "": deptEntity.getDepartName());
