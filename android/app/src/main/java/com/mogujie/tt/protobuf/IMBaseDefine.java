...
public final class IMBaseDefine {
  ...
  bitField0_ |= 0x00000001;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (IpAddr.class) {
              if (PARSER == null) {
  ...
  bitField0_ |= 0x00000400;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (UserInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class ContactSessionInfo extends
    ...
    public SessionType getSessionType() {
      SessionType result = SessionType.forNumber(sessionType_);
      return result == null ? SessionType.SESSION_TYPE_SINGLE : result;
    }
    /**
     * <code>required .IM.BaseDefine.SessionType session_type = 2;</code>
     */
    private void setSessionType(SessionType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000002;
    ...
    public SessionStatusType getSessionStatus() {
      SessionStatusType result = SessionStatusType.forNumber(sessionStatus_);
      return result == null ? SessionStatusType.SESSION_STATUS_OK : result;
    }
    /**
     * <code>required .IM.BaseDefine.SessionStatusType session_status = 3;</code>
     */
    private void setSessionStatus(SessionStatusType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000004;
  ...
  bitField0_ |= 0x00000020;
    ...
    public MsgType getLatestMsgType() {
      MsgType result = MsgType.forNumber(latestMsgType_);
      return result == null ? MsgType.MSG_TYPE_SINGLE_TEXT : result;
    }
    /**
     * <code>required .IM.BaseDefine.MsgType latest_msg_type = 7;</code>
     */
    private void setLatestMsgType(MsgType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000040;
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          ContactSessionInfo, Builder> implements
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          ContactSessionInfo other = (ContactSessionInfo) arg1;
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 16: {
                  ...
                  SessionType value = SessionType.forNumber(rawValue);
                  if (value == null) {
                ...
                case 24: {
                  int rawValue = input.readEnum();
                  SessionStatusType value = SessionStatusType.forNumber(rawValue);
                  if (value == null) {
                ...
                case 56: {
                  int rawValue = input.readEnum();
                  MsgType value = MsgType.forNumber(rawValue);
                  if (value == null) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (ContactSessionInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class UserStat extends
    ...
    public UserStatType getStatus() {
      UserStatType result = UserStatType.forNumber(status_);
      return result == null ? UserStatType.USER_STATUS_ONLINE : result;
    }
    /**
     * <code>required .IM.BaseDefine.UserStatType status = 2;</code>
     */
    private void setStatus(UserStatType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000002;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 16: {
                  int rawValue = input.readEnum();
                  UserStatType value = UserStatType.forNumber(rawValue);
                  if (value == null) {
                    super.mergeVarintField(2, rawValue);
                  } else {
                    bitField0_ |= 0x00000002;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (UserStat.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class ServerUserStat extends
    ...
    public ClientType getClientType() {
      ClientType result = ClientType.forNumber(clientType_);
      return result == null ? ClientType.CLIENT_TYPE_WINDOWS : result;
    }
    /**
     * <code>required .IM.BaseDefine.ClientType client_type = 3;</code>
     */
    private void setClientType(ClientType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000004;
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          ServerUserStat, Builder> implements
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          ServerUserStat other = (ServerUserStat) arg1;
          userId_ = visitor.visitLong(
              hasUserId(), userId_,
              other.hasUserId(), other.userId_);
          status_ = visitor.visitInt(hasStatus(), status_,
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 24: {
                  int rawValue = input.readEnum();
                  ClientType value = ClientType.forNumber(rawValue);
                  if (value == null) {
                    super.mergeVarintField(3, rawValue);
                  } else {
                    bitField0_ |= 0x00000004;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (ServerUserStat.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000010;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          UnreadInfo other = (UnreadInfo) arg1;
          sessionId_ = visitor.visitLong(
              hasSessionId(), sessionId_,
              other.hasSessionId(), other.sessionId_);
          sessionType_ = visitor.visitInt(hasSessionType(), sessionType_,
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (UnreadInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class MsgInfo extends
    ...
    public MsgType getMsgType() {
      MsgType result = MsgType.forNumber(msgType_);
      return result == null ? MsgType.MSG_TYPE_SINGLE_TEXT : result;
    }
    /**
     * <code>required .IM.BaseDefine.MsgType msg_type = 4;</code>
     */
    private void setMsgType(MsgType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000008;
  ...
  public  static final class GroupVersionInfo extends
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          GroupVersionInfo, Builder> implements
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          GroupVersionInfo other = (GroupVersionInfo) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (GroupVersionInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public interface GroupInfoOrBuilder extends
     ...
     */
    java.util.List<Long> getGroupMemberListList();
    /**
     * <code>repeated uint64 group_member_list = 8;</code>
     */
  ...
  bitField0_ |= 0x00000008;
    ...
    public GroupType getGroupType() {
      GroupType result = GroupType.forNumber(groupType_);
      return result == null ? GroupType.GROUP_TYPE_NORMAL : result;
    }
    /**
     * <code>required .IM.BaseDefine.GroupType group_type = 6;</code>
     */
    private void setGroupType(GroupType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000020;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          GroupInfo other = (GroupInfo) arg1;
          groupId_ = visitor.visitLong(
              hasGroupId(), groupId_,
              other.hasGroupId(), other.groupId_);
          version_ = visitor.visitInt(
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 48: {
                  int rawValue = input.readEnum();
                  GroupType value = GroupType.forNumber(rawValue);
                  if (value == null) {
                    super.mergeVarintField(6, rawValue);
                  } else {
                    bitField0_ |= 0x00000020;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (GroupInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class UserTokenInfo extends
    ...
    public ClientType getUserType() {
      ClientType result = ClientType.forNumber(userType_);
      return result == null ? ClientType.CLIENT_TYPE_WINDOWS : result;
    }
    /**
     * <code>required .IM.BaseDefine.ClientType user_type = 2;</code>
     */
    private void setUserType(ClientType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000002;
  ...
  bitField0_ |= 0x00000004;
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          UserTokenInfo, Builder> implements
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          UserTokenInfo other = (UserTokenInfo) arg1;
          userId_ = visitor.visitLong(
              hasUserId(), userId_,
              other.hasUserId(), other.userId_);
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (UserTokenInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000001;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          PushResult other = (PushResult) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (PushResult.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class ShieldStatus extends
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          ShieldStatus, Builder> implements
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          ShieldStatus other = (ShieldStatus) arg1;
          userId_ = visitor.visitLong(
              hasUserId(), userId_,
              other.hasUserId(), other.userId_);
          groupId_ = visitor.visitLong(
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (ShieldStatus.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000004;
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          OfflineFileInfo, Builder> implements
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          OfflineFileInfo other = (OfflineFileInfo) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (OfflineFileInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000004;
    ...
    public DepartmentStatusType getDeptStatus() {
      DepartmentStatusType result = DepartmentStatusType.forNumber(deptStatus_);
      return result == null ? DepartmentStatusType.DEPT_STATUS_OK : result;
    }
    /**
     * <code>required .IM.BaseDefine.DepartmentStatusType dept_status = 5;</code>
     */
    private void setDeptStatus(DepartmentStatusType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000010;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          DepartInfo other = (DepartInfo) arg1;
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 40: {
                  int rawValue = input.readEnum();
                  DepartmentStatusType value = DepartmentStatusType.forNumber(rawValue);
                  if (value == null) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (DepartInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class PushShieldStatus extends
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          PushShieldStatus, Builder> implements
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          PushShieldStatus other = (PushShieldStatus) arg1;
          userId_ = visitor.visitLong(
              hasUserId(), userId_,
              other.hasUserId(), other.userId_);
          shieldStatus_ = visitor.visitInt(
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (PushShieldStatus.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
