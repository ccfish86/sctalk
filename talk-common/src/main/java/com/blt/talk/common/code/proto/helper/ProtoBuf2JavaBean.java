...
import com.blt.talk.common.model.AudioMessage;
import com.blt.talk.common.model.MessageEntity;
import com.blt.talk.common.model.MsgAnalyzeEngine;
...
@Deprecated
 class ProtoBuf2JavaBean {
    ...
    public static SessionEntity getSessionEntity(IMBaseDefine.ContactSessionInfo sessionInfo){
        ...
        String desMessage = new String(SecurityUtils.getInstance().DecryptMsg(content));
        // 判断具体的类型是什么
