...
/**
 * The class would represent the FiveTuple object of TURN protocol. The hashCode function should be
 * unique if possible since it will be used to uniquely find the allocation object.
 * 
 * @author Aakash Garg
 */
public class FiveTuple {
     ...
     * output.
     */
    private static final Logger logger = LoggerFactory.getLogger(FiveTuple.class.getName());
    ...
    /**
     * @return the clientTransportAddress or null if the the Client's Address has not been set.
     */
    ...
    /**
     * @return client's port number as +ve int value or -1 if the the Client's Address has not been
     *         set.
     */
    ...
    /**
     * @return client Host Address in String or null if the the Client's Address has not been set.
     */
    ...
    /**
     * @return the serverTransportAddress or null if the the Server's Address has not been set.
     */
    ...
    /**
     * @return server's port number as +ve int value or -1 if the the Server's Address has not been
     *         set.
     */
    ...
    /**
     * @return server Host Address in String or null if the the Server's Address has not been set.
     */
    ...
    public int hashCode() {
        ...
        int result = 1;
        result = prime * result
                + ((clientTransportAddress == null) ? 0 : clientTransportAddress.hashCode());
        result = prime * result
                + ((serverTransportAddress == null) ? 0 : serverTransportAddress.hashCode());
    ...
    public String toString() {
        return "FiveTuple ["
                + (getClientTransportAddress() != null
                        ? "getClientAddress()=" + getClientTransportAddress() + ", "
                        : "")
                + (getServerTransportAddress() != null
                        ? "getServerAddress()=" + getServerTransportAddress() + ", "
                        : "")
