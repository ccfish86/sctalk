...
public class Permission {
    ...
    /**
     * @param ipAddress contains the peer IP address and transport protocol to be assigned. The port
     *        value is ignored.
     */
    ...
    /**
     * @param ipAddress the ipAddress of the peer for which to create Permission.
     */
    public void setIpAddress(TransportAddress ipAddress) {
        this.ipAddress =
                new TransportAddress(ipAddress.getHostAddress(), 0, ipAddress.getTransport());
    }
    ...
    /**
     * Returns the lifetime associated with this Permission. If the Permission is expired it returns
     * 0.
     */
    ...
    /**
     * Sets the time to expire in milli-seconds for this Permission. Max lifetime can be
     * Permission.MAX_LIFEIME.
     * 
    ...
    public void setLifetime(long lifetime) {
        synchronized (this) {
            this.expirationTime =
                    System.currentTimeMillis() + Math.min(lifetime * 1000, Permission.MAX_LIFETIME);
        }
    }
    ...
    /**
     * Start the Permission. This launches the countdown to the moment the Permission would expire.
     */
     ...
     *
     * @return <tt>true</tt> if this <tt>Permission</tT> is expired now; otherwise, <tt>false</tt>
     */
    ...
    /**
     * Expires the Permission. Once this method is called the Permission is considered terminated.
     */
    ...
    /**
     * Determines whether this <tt>Permission</tt> will be expired at a specific point in time.
     *
     * @param now the time in milliseconds at which the <tt>expired</tt> state of this
     *        <tt>Permission</tt> is to be returned
     * @return <tt>true</tt> if this <tt>Permission</tt> will be expired at the specified point in
    ...
    /*
     * The permission is uniquely identified by its IP address, so hashCode is calculated on the IP
     * address only.
     */
    @Override
    public int hashCode() {
    ...
    /*
     * Two Permissions are equal if their associated IP address, lifetime and transport protocol are
     * same.
     */
    @Override
    public boolean equals(Object obj) {
        ...
        } else if (ipAddress.getHostAddress().compareTo(other.ipAddress.getHostAddress()) != 0) {
            return false;
        }
    ...
    public String toString() {
        return "Permission [" + (ipAddress != null ? "ipAddress=" + ipAddress : "") + "]";
    }
}
