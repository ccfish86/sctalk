...
public class ChannelBind {
     ...
     * Our class logger.
     */
    private static final Logger logger = LoggerFactory.getLogger(ChannelBind.class.getName());
    ...
    /**
     * Creates a new ChannelBind object with MAX_LIFETIME as default lifetime value.
     * 
     * @param peerAddress contains the peer IP address with port no and transport protocol to be
     *        assigned.
     * @param channelNo the channelNo of ChannelBind.
     */
    public ChannelBind(TransportAddress peerAddress, char channelNo) {
     ...
     * 
     * @param peerAddress contains the peer IP address and transport protocol to be assigned. The
     *        port value is ignored.
     * @param channelNo the channelNo of the ChannelBind request.
     * @param lifetime the lifetime of ChannelBind.
     */
    public ChannelBind(TransportAddress peerAddress, char channelNo, long lifetime) {
    ...
    /**
     * Returns the lifetime associated with this ChannelBind. If the ChannelBind is expired it
     * returns 0.
     */
    ...
    /**
     * Sets the time to expire in milliseconds for this ChannelBind. Max lifetime can be
     * ChannelBind.MAX_LIFEIME.
     * 
    ...
    /**
     * Start the ChannelBind. This launches the countdown to the moment the ChannelBind would
     * expire.
     */
     ...
     *
     * @return <tt>true</tt> if this <tt>ChannelBind</tT> is expired now; otherwise, <tt>false</tt>
     */
    ...
    /**
     * Expires the ChannelBind. Once this method is called the ChannelBind is considered terminated.
     */
    public synchronized void expire() {
        expired = true;
        /*
         * Allocation has a background Thread running with the purpose of removing expired
         * ChannelBinds.
         */
    }

    /**
     * Determines whether this <tt>ChannelBind</tt> will be expired at a specific point in time.
     *
     * @param now the time in milliseconds at which the <tt>expired</tt> state of this
     *        <tt>ChannelBind</tt> is to be returned
     * @return <tt>true</tt> if this <tt>ChannelBind</tt> will be expired at the specified point in
    ...
    public boolean equals(Object o) {
        ...
        if (c.getChannelNo() == this.channelNo && c.getPeerAddress().equals(this.peerAddress)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "ChannelBind [" + (peerAddress != null ? "peerAddress=" + peerAddress + ", " : "")
