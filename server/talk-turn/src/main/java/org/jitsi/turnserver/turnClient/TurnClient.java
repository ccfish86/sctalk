...
/**
 * The class would be acting as a TurnClient. The client runs on UDP initiates displays network
 * configuration <br>
 * Usage from command prompt <br>
 * 
 * java org.ice4j.Turnclient.TurnCient Turnserver.org TurnPort <br>
 * (Displays the network configuration and port mapping using Turnserver.org as Turnserver and
 * TurnPort as server's Turn port<br>
 * * java org.ice4j.Turnclient.TurnCient N <br>
 * (chooses server from array of { "Turnserver.org", "Turn.softjoys.com", "Turn.voiparound.com",
 * "Turn.voipbuster.com", "Turn.voipTurnt.com", "Turn.voxgratia.org", "Turn.ekiga.net",
 * "Turn.ideasip.com", "Turn.iptel.org", "Turn.rixtelecom.se" })
 * 
 * @author Aakash
 * 
 */
...
public class TurnClient {
    ...
    private static Logger logger = LoggerFactory.getLogger(TurnClient.class);
