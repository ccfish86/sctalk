...
/**
 * The class that would be handling and responding to incoming ConnectionBind response.
 * 
 * @author Aakash Garg
 */
public class ConnectionBindResponseCollector implements ResponseCollector {
    ...
    /**
     * The <tt>Logger</tt> used by the <tt>ConnectionBindresponseCollector</tt> class and its
     * instances for logging output.
     */
    private static final Logger logger =
            LoggerFactory.getLogger(ConnectionBindResponseCollector.class.getName());
