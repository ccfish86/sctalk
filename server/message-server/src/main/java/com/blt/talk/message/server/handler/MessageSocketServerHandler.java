 ...
 * @since  1.0
 */
public class MessageSocketServerHandler extends SimpleChannelInboundHandler<Object> {

    private Logger logger = LoggerFactory.getLogger(MessageSocketServerHandler.class);
    ...
    public MessageSocketServerHandler() {
        super();
    }

    public MessageSocketServerHandler(HandlerManager handlerManager) {
        super();
        this.handlerManager = handlerManager;
    }
